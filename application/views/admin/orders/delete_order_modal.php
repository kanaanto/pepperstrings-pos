	  ...
	  <div class="modal-dialog" role="document">
		<div class="modal-content">
		  <div class="modal-header ">
			...
			<h4 class="modal-title" id="delete_order_modal">Delete Order</h4>
		  </div>
		  <div class="modal-body">
			<span>
			<h4>Are you sure you want to delete this order? This action cannot be undone and the order will be deleted from the database.</h4>
			</span>
		  </div>
